...
def init_segmentation(args, device):
    ...
    register_coco_instances("compressed_coco_seg", {}, json_path, image_path)
    evaluator = COCOEvaluator("compressed_coco_seg", cfg, distributed=False, output_dir="./coco_log")
    
    evaluator.reset()
    test_dataloader = build_detection_test_loader(cfg, "compressed_coco_seg")
